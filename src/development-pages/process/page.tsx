        ...
        <div className="mt-12 lg:mt-0 lg:w-[37rem] lg:flex-none lg:group-even/section:order-first">
          <FadeIn>
            <div
              ...
              aria-hidden="true"
            />
            <h2 className="mt-2 font-display text-3xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-tr from-red-500 to-amber-500 sm:text-4xl">
              {title}
            </h2>
...
function Build() {
  return (
    <Section title="Build" image={{ src: imageLaptop, shape: 1 }}>
      ...
      <Blockquote
        author={{ name: 'Debra Fiscal', role: 'CEO of PharmSystems International' }}
        className="mt-12"
      >
        Catalyst Labs was so regular with their progress updates we almost began to
    ...
    <Section title="Deliver" image={{ src: imageMeeting, shape: 2 }}>
      ...
      <List className="mt-8">
        <ListItem title="Testing">
          After implementation, we'll calibrate and optimize every variable to ensure optimal peformance and specifications are met or exceeded.
        </ListItem>
        <ListItem title="Infrastructure">
          We'll ensure that your technology systems, workforace, and physical facilities are outfitted with everything you need to operationalize.
        </ListItem>
        <ListItem title="Support">
          We've got your back, long after the project is completed! Our team is just a phone call away in case of issues or failures.
        </ListItem>
      </List>
    </Section>
  )
