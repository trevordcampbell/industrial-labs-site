...
export function MagicCardWithGradient() {
  return (
    <MagicContainer
      className={
    ...
    >
      <MagicCard
        className="flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden px-10 shadow-2xl"
      >
        <div className="z-10 flex place-items-start space-x-4">
          <Image src={"https://landingfoliocom.imgix.net/store/collection/dusk/images/features/2/feature-3.png"} width={60} height={60} alt={""} unoptimized />
          <h4 className="text-base text-neutral-600"><span className="text-neutral-950 text-lg font-semibold mr-2">Aerospace & Defense Technologies: </span>Our team is skilled in developing solutions that meet the rigorous demands of aerospace and defense applications, from avionics to mission-critical software.</h4>
        </div>
